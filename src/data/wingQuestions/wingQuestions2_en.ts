export const type2WingQuestions: WingTestData = {
  ...
  questions: [
    {
      ...
      optionA: {
        text: "I ensure I do it the **right way** – with respect for rules, ethics, and what is best in the long run. It is important to me that the help is thorough and morally sound.",
        wing: "w1",
      ...
      optionB: {
        ...
        wing: "w3",
        description: "Uses Type 3's pragmatic and results-oriented approach to helping."
      }
    },
    {
      question: "My motivation for helping comes from:",
      optionA: {
        text: "An inner desire to do the right thing and be a good person. I feel a responsibility to act ethically and help in a way that is morally correct.",
        wing: "w1",
    ...
    },
    {
      ...
      optionA: {
        text: "I become **irritated** because I feel they are ignoring the right choice. It frustrates me when people don't want to do what is best for them.",
        wing: "w1",
        description: "Type 1's frustration over wrong choices and lack of responsiveness to principles."
      }
      ,
      optionB: {
        text: "I feel **rejected** and unappreciated. It hurts when my effort is not acknowledged or received with gratitude.",
        wing: "w3",
    ...
    },
    {
      ...
      optionA: {
        text: "I try to find the most **correct and principled solution** – something that is sustainable and ethically sound.",
        wing: "w1",
        description: "Type 1's focus on the right answer and moral integrity in problem-solving."
      },
      optionB: {
        text: "I focus on what **works best** for them here and now. I adapt the solution to their needs and situation.",
        wing: "w3",
    ...
    },
    {
      ...
      optionA: {
        ...
        wing: "w1",
        description: "Type 1's moral guidance and desire to promote the good and the right."
      },
      optionB: {
    ...
    },
    {
      ...
      optionA: {
        text: "**Structured and organized** support. I plan my help and ensure everything is done thoroughly and correctly.",
        wing: "w1",
    ...
    {
      question: "When I see people doing things incorrectly:",
      optionA: {
      ...
      optionB: {
        text: "I help them find a solution that **works for them**. The most important thing is that they move forward and achieve success.",
        wing: "w3",
        description: "Type 3's solution-oriented approach, where effectiveness and progress are the focus."
      }
    },
    {
      question: "My criticism of others is often about:",
      optionA: {
        text: "That they do not live up to the **right standards**. I want people to do their best and act responsibly.",
        wing: "w1",
        description: "Type 1's focus on ethics, quality, and responsibility in their assessment of others."
      },
      optionB: {
        text: "That they do not exploit their **potential**. I see what they could achieve and get frustrated when they don't seize the opportunity.",
        wing: "w3",
        description: "Type 3's focus on performance and development – and disappointment when it is not realised."
      }
    },
    {
      question: "When I organize help for others:",
      optionA: {
        text: "I ensure that everything is done **correctly and thoroughly**. I want to ensure the help is responsible and well-considered.",
        wing: "w1",
        description: "Type 1's thoroughness and sense of order in their helpfulness."
      },
      optionB: {
        text: "I ensure that it **looks good** and works efficiently. I want to create results and make a good impression.",
        wing: "w3",
    ...
    },
    {
      ...
      optionA: {
        text: "People do not do things **properly**, even though I have helped them. It feels like my effort is wasted.",
        wing: "w1",
        description: "Type 1's frustration over lack of quality and respect for effort."
      },
      optionB: {
        text: "My help is not **recognized** or appreciated. I feel invisible, even though I have made a great effort.",
        wing: "w3",
  ...
  descriptions: {
    w1: {
      title: "Type 2w1 - The Principled Helper (The Servant)",
      description: "You combine Type 2's helpful nature with Type 1's focus on doing things correctly. You help others in a structured and responsible way.",
      characteristics: [
    ...
    w3: {
      title: "Type 2w3 - The Ambitious Helper (The Host/Hostess)",
    ...
    balanced: {
      ...
      description: "You use both Type 1's principled approach and Type 3's results-oriented methods flexibly in your helpfulness.",
      characteristics: [
        ...
        "switches between correcting and inspiring",
