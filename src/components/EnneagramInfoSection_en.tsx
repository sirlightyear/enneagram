...
import { triadInfo, stressGrowthLines, getTriadForType, basicFearsInfo, basicDesiresInfo } from '../data/enneagramInfo_en';
...
                  Your Basic Fear - What drives you?
                </h3>
                <p className="text-sm text-gray-600 mt-1">
                  Understand the deep-seated fear behind your type
                </p>
              </div>
            </div>
            {showBasicFear ? (
...
                      <strong>Basic Fear:</strong> {userFearInfo.fear}
                    </p>
                  </div>
                </div>
...
                  <strong>Source:</strong> {basicFearsInfo.source}
                </p>
              </div>
            </div>
          )}
...
              <div className="text-left">
                <h3 className="text-xl font-semibold text-gray-800">
                  Your Basic Desire - What are you seeking?
                </h3>
                <p className="text-sm text-gray-600 mt-1">
                  Understand the longing that shapes your behavior
                </p>
              </div>
            </div>
            {showBasicDesire ? (
...
                      <strong>Basic Desire:</strong> {userDesireInfo.desire}
                    </p>
                  </div>
                </div>
...
                    <strong>The Dynamic:</strong> {userDesireInfo.dynamic}
                  </p>
                </div>
              </div>
...
            <div className="text-left">
              <h3 className="text-xl font-semibold text-gray-800">
                Understanding the Three Enneagram Triads
              </h3>
              <p className="text-sm text-gray-600 mt-1">
                {userTriad && `You belong to the ${triadInfo.triads[userTriad].title}`}
              </p>
            </div>
            </div>
          {showTriads ? (
...
              <div className="text-left">
                <h3 className="text-xl font-semibold text-gray-800">
                  Your Stress and Growth Directions
                </h3>
                <p className="text-sm text-gray-600 mt-1">
                  Learn how you develop under pressure and in well-being
                </p>
              </div>
            </div>
            {showStressGrowth ? (
...
                      In Growth → {stressGrowthInfo.growth.movesTo}
                    </h4>
                  </div>
...
                        </span>
                      </div>
                      <span className="text-xs text-indigo-600 font-bold">YOU</span>
                    </div>
