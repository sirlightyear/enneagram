...
import { triadInfo, stressGrowthLines, getTriadForType, basicFearsInfo, basicDesiresInfo } from '../data/enneagramInfo_uk';
...
                  Ваш Основний Страх - Що вами керує?
                </h3>
                <p className="text-sm text-gray-600 mt-1">
                  Зрозумійте глибинний страх, що стоїть за вашим типом
                </p>
              </div>
            </div>
            {showBasicFear ? (
...
                      <strong>Основний Страх:</strong> {userFearInfo.fear}
                    </p>
                  </div>
                </div>
...
                  <strong>Джерело:</strong> {basicFearsInfo.source}
                </p>
              </div>
            </div>
          )}
...
              <div className="text-left">
                <h3 className="text-xl font-semibold text-gray-800">
                  Ваше Основне Бажання - Чого ви прагнете?
                </h3>
                <p className="text-sm text-gray-600 mt-1">
                  Зрозумійте прагнення, яке формує вашу поведінку
                </p>
              </div>
            </div>
            {showBasicDesire ? (
...
                      <strong>Основне Бажання:</strong> {userDesireInfo.desire}
                    </p>
                  </div>
                </div>
...
                    <strong>Динаміка:</strong> {userDesireInfo.dynamic}
                  </p>
                </div>
              </div>
...
            <div className="text-left">
              <h3 className="text-xl font-semibold text-gray-800">
                Розуміння Трьох Тріад Еннеаграми
              </h3>
              <p className="text-sm text-gray-600 mt-1">
                {userTriad && `Ви належите до ${triadInfo.triads[userTriad].title}`}
              </p>
            </div>
          </div>
          {showTriads ? (
...
                      <strong>Типи:</strong> {triad.types.join(', ')}
                    </div>
...
            <div className="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
              <p className="text-sm text-gray-600">
                <strong>Джерело:</strong> The Wisdom of the Enneagram, Riso & Hudson
              </p>
            </div>
          </div>
        )}
...
              <div className="text-left">
                <h3 className="text-xl font-semibold text-gray-800">
                  Ваші Напрямки Стресу та Зростання
                </h3>
                <p className="text-sm text-gray-600 mt-1">
                  Дізнайтеся, як ви розвиваєтеся під тиском і у стані благополуччя
                </p>
              </div>
            </div>
            {showStressGrowth ? (
...
                      Під Стресом → {stressGrowthInfo.stress.movesTo}
                    </h4>
                  </div>
...
                      У Зростанні → {stressGrowthInfo.growth.movesTo}
                    </h4>
                  </div>
...
                      </span>
                    </div>
                    <span className="text-xs text-red-600 font-medium">Стрес</span>
                  </div>
...
                        </span>
                      </div>
                      <span className="text-xs text-indigo-600 font-bold">ВИ</span>
                    </div>
...
                      </span>
                    </div>
                    <span className="text-xs text-green-600 font-medium">Зростання</span>
                  </div>
                </div>
              </div>
            </div>
