...
const WingResultsPage_de: React.FC<WingResultsPageProps> = ({
  wingResult,
  wingTestData,
  primaryType,
  onBack,
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-100 via-amber-50 to-fuchsia-200 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Ihre Enneagramm-Flügel</h1>
          <p className="text-gray-600">Ein tieferes Verständnis Ihres {primaryType}</p>
        </div>
        ...
        {/* Characteristics */}
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          <h3 className="text-xl font-semibold text-gray-800 mb-6">Charakteristika für Ihre Flügel-Kombination</h3>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          <div className="flex items-center mb-6">
            ...
            <h3 className="text-xl font-semibold text-gray-800">Ihre Flügel-Scores</h3>
          </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="text-indigo-600 font-semibold">
                  {wingResult.primaryScore} Antworten
                </span>
              </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="text-gray-600 font-semibold">
                  {wingResult.secondaryScore} Antworten
                </span>
              </div>
              <div className="w-full bg-gray-200 rounded-full h-3">
                <div
          ...
          {wingResult.isBalanced && (
            <div className="mt-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              <p className="text-yellow-800 text-sm">
                <strong>Ausgewogene Flügel:</strong> Ihre Scores sind sehr nahe beieinander, was bedeutet, dass Sie beide Flügel flexibel je nach Situation nutzen.
              </p>
            </div>
          )}
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          >
            ...
            Zurück zu den Hauptergebnissen
          </button>
...
export default WingResultsPage_de;
