...
const WingResultsPage_nl: React.FC<WingResultsPageProps> = ({
  wingResult,
  wingTestData,
  primaryType,
  onBack,
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-100 via-amber-50 to-fuchsia-200 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Uw Enneagram-vleugels</h1>
          <p className="text-gray-600">Een dieper begrip van uw {primaryType}</p>
        </div>
        ...
        {/* Characteristics */}
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          <h3 className="text-xl font-semibold text-gray-800 mb-6">Kenmerken van uw type</h3>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          <div className="flex items-center mb-6">
            ...
            <h3 className="text-xl font-semibold text-gray-800">Uw vleugel-scores</h3>
          </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="text-indigo-600 font-semibold">
                  {wingResult.primaryScore} antwoorden
                </span>
              </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="text-gray-600 font-semibold">
                  {wingResult.secondaryScore} antwoorden
                </span>
              </div>
              <div className="w-full bg-gray-200 rounded-full h-3">
                <div
          ...
          {wingResult.isBalanced && (
            <div className="mt-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              <p className="text-yellow-800 text-sm">
                <strong>Gebalanceerde vleugels:</strong> Uw scores liggen heel dicht bij elkaar, wat betekent dat u beide vleugels flexibel gebruikt afhankelijk van de situatie.
              </p>
            </div>
          )}
        </div>
...
export default WingResultsPage_nl;
