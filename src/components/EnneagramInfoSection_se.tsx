...
                  Din Grundläggande Rädsla - Vad driver dig?
                </h3>
                <p className="text-sm text-gray-600 mt-1">
                  Förstå den djupt rotade rädslan bakom din typ
                </p>
              </div>
            </div>
            {showBasicFear ? (
...
                      <strong>Grundläggande Rädsla:</strong> {userFearInfo.fear}
                    </p>
                  </div>
                </div>
...
                  <strong>Källa:</strong> {basicFearsInfo.source}
                </p>
              </div>
            </div>
          )}
...
              <div className="text-left">
                <h3 className="text-xl font-semibold text-gray-800">
                  Ditt Grundläggande Begär - Vad söker du?
                </h3>
                <p className="text-sm text-gray-600 mt-1">
                  Förstå längtan som formar ditt beteende
                </p>
              </div>
            </div>
            {showBasicDesire ? (
...
                      <strong>Grundläggande Begär:</strong> {userDesireInfo.desire}
                    </p>
                  </div>
                </div>
...
                    <strong>Dynamiken:</strong> {userDesireInfo.dynamic}
                  </p>
                </div>
              </div>
...
            <div className="text-left">
              <h3 className="text-xl font-semibold text-gray-800">
                Förstå de Tre Enneagram-Triaderna
              </h3>
              <p className="text-sm text-gray-600 mt-1">
                {userTriad && `Du tillhör ${triadInfo.triads[userTriad].title}`}
              </p>
            </div>
          </div>
          {showTriads ? (
...
              
              <p className="text-sm text-gray-600">
                <strong>Källa:</strong> The Wisdom of the Enneagram, Riso & Hudson
              </p>
            </div>
          </div>
        )}
...
              <div className="text-left">
                <h3 className="text-xl font-semibold text-gray-800">
                  Dina Stress- och Utvecklingsriktningar
                </h3>
                <p className="text-sm text-gray-600 mt-1">
                  Lär dig hur du utvecklas under press och i välbefinnande
                </p>
              </div>
            </div>
            {showStressGrowth ? (
...
                      I Utveckling → {stressGrowthInfo.growth.movesTo}
                    </h4>
                  </div>
...
                      </span>
                    </div>
                    <span className="text-xs text-green-600 font-medium">Utveckling</span>
                  </div>
                </div>
              </div>
            </div>
