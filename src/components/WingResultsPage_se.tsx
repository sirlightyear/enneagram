...
const WingResultsPage_se: React.FC<WingResultsPageProps> = ({
  wingResult,
  wingTestData,
  primaryType,
  onBack,
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-100 via-amber-50 to-fuchsia-200 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Dina Enneagram-vingar</h1>
          <p className="text-gray-600">En djupare förståelse av din {primaryType}</p>
        </div>
        ...
        {/* Characteristics */}
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          <h3 className="text-xl font-semibold text-gray-800 mb-6">Karakteristika för din typ</h3>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          <div className="flex items-center mb-6">
            ...
            <h3 className="text-xl font-semibold text-gray-800">Dina vinge-poäng</h3>
          </div>
          ...
          {wingResult.isBalanced && (
            <div className="mt-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              <p className="text-yellow-800 text-sm">
                <strong>Balanserade vingar:</strong> Dina poäng är mycket nära, vilket betyder att du använder båda vingarna flexibelt beroende på situationen.
              </p>
            </div>
          )}
        </div>
...
export default WingResultsPage_se;
